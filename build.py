...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','dk.napp.appearance.js')
	...
	f = os.path.join(cwd,'Classes','DkNappAppearanceModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','dk.napp.appearance.js']
